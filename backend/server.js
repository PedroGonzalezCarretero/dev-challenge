    ...
    gRpcServer.bindAsync(
        ...
        (err) => {
            ...
            app.listen(PORT, () => {
                ...
                console.log(
                    `You can access through http://localhost:${process.env.LOCAL_PORT_API}`
                );
                console.log('');
                console.log(`🔌 gRPC SERVER running on port ${GRPC_PORT}`);
                console.log(
                    `You can access through http://localhost:${process.env.LOCAL_GRPC_PORT_API}`
                );
                console.log('');
                console.log('');
                console.log(`👾 DEBUGGER SERVER running on port ${DEBUG_PORT}`);
                console.log(
                    `You can access through http://localhost:${process.env.LOCAL_DEBUG_PORT}`
                );
                console.log(
                    '======================================================================'
                );
